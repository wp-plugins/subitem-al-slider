...
public function register_scripts_fronend()
  ...
  $helper = new Sial_Helper();
    ...
    $helper->registerStylefront("subitem_al_slider_common_css", "css/subitem_al_slider_common.css");
  ...
  if ($jquery_ui_library_use)
    {
      $helper->registerStylefront("jquery-ui", "css/jquery-ui.css");
    }
...
public function print_scripts_fronend()
  ...
  $helper = new Sial_Helper();
    ...
    $helper->printStylefront("subitem_al_slider_common_css", "css/subitem_al_slider_common.css");
  ...
  if ($jquery_ui_library_use)
    {
      $helper->printStylefront("jquery-ui", "css/jquery-ui.css");
    }
