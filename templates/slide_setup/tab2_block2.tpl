...
<button name="create_item" type="button" class="create_item hdn" id="create_item_[CONTIDONLY]" data-role="button">Create Item</button>
<button name="create_singleitem" type="button" class="create_singleitem hdn" id="create_singleitem_[CONTIDONLY]" data-role="button">Create Single Element</button>
...
Duration:
<input type="text" name="duration" size="10" class="duration digits_fld" value="1000">
<br>
Effect's duration:
<input type="text" name="duration_effect" size="10" class="duration_effect digits_fld" value="100">

Left Offset:
<input type="text" name="offset_left_inner" size="10" class="digits_fld" value="0">

Top Offset:
<input type="text" name="offset_top_inner" size="10" class="digits_fld" value="0">
...
<div class="container_creation_area" id="container_creation_area_[CONTIDONLY]">

</div>

<h4 style='font-weight:bold;'>Single elements</h4>
<div class="container_creation_area_move" id="container_creation_area_move_[CONTIDONLY]">
<div class="accordion">
...
<?php
 ...
 ?>
    ...
    <input type="text" class="digits_fld" name="single[font_size][]" value="0">
    </td>
    </tr>
    <tr><td colspan="6">
