...
?>
<div class="subitem_al_wrapper subitem_al_slider_outter"  id="subitem_al_wrapper_<?php echo $unq; ?>" style="display:none;">
...
foreach ($items['containers'] as $ctnkey=>$ctn)
 ...
 <div id="subitem_al_item_<?php echo $ctnkey; ?>" class="<?php echo $little_class; ?> subitem_al_item subitem_al_item_<?php echo $unq; ?>_<?php echo $ctnkey; ?>" style="width:<?php if (isset($items['main']['activewidth']))echo $items['main']['activewidth']; ?>px;height:<?php if (isset($items['main']['activeheight']))echo $items['main']['activeheight']; ?>px;">
   ...
   <div id="subitem_al_subitem_<?php echo $ctnkey; ?>_01"  class="subitem-al-no-flick-small subitem_al_subitem" style="width:<?php if (isset($items['main']['activewidth']))echo $items['main']['activewidth']; ?>px;height:<?php if (isset($items['main']['activeheight']))echo $items['main']['activeheight']; ?>px;">
      ...
      <div id="subitem_al_subitem_<?php echo $ctnkey; ?>_02"  class="subitem-al-no-flick-small subitem_al_subitem"> <!--style="display:none;"-->
       <div class="subitem_al_slider-wrapper subitem-al-no-flick-small">
        <div id="subitem_al_slider<?php echo $ctnkey; ?>" class="subitem-al-no-flick-small">
<?php
if ((isset($ctn['groups'])&&(is_array($ctn['groups'])&&(!empty($ctn['groups'])))))
  foreach ($ctn['groups'] as $gr)
    ...
    ?>
          <div class="subitem_al_slide1 subitem-al-no-flick-small" style="width:<?php if (isset($maxwidth))echo $maxwidth; ?>px;height:<?php if (isset($maxheight))echo $maxheight; ?>px;">
<?php
        ...
        $containers_functions_end = "";
          ...
          if (isset($mv['groups']))
           ...
           if (!empty($mv['mvurl'])) echo "<a href='".$mv['mvurl']."'>";
              echo "<div class='noborder ".$elem_class."'><div class='noborder subitem_al_group_elem ".substr($mv['id_selector'],1)."' style='display:none;'>";
