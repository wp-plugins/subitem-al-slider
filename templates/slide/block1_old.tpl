...
function out_groups_inside($gr, $container_img_script, $counting, $ctnkey, $unq)
  {
    ...
    ?>
          ...
          if (isset($gritem['imurl'])&&(!empty($gritem['imurl'])))
            {
          ?>
          <div class="subitem_al_img <?php if (isset($gritem['imclasses_list']))echo $gritem['imclasses_list']; ?>" style='left:<?php echo $gritem['imoffsetleft']; ?>px;top:<?php echo $gritem['imoffsettop']; ?>px;width:<?php echo $gritem['imwidth']; ?>px;height:<?php echo $gritem['imheight']; ?>px;'>
                <a href='<?php echo $gritem['imurl']; ?>'><img src="<?php echo plugins_url("../../images/empty.gif", __FILE__); ?>" class="subitem_al_imgs_<?php echo $unq; ?>_<?php echo $counting; ?>" alt="" style='width:<?php echo $gritem['imwidth']; ?>px;height:<?php echo $gritem['imheight']; ?>px;'/></a>
          </div>
          <?php
            }
          else
          ...
          ?>
          <div class="subitem_al_img <?php if (isset($gritem['imclasses_list']))echo $gritem['imclasses_list']; ?>" style='left:<?php echo $gritem['imoffsetleft']; ?>px;top:<?php echo $gritem['imoffsettop']; ?>px;width:<?php echo $gritem['imwidth']; ?>px;height:<?php echo $gritem['imheight']; ?>px;'>
                <img src="<?php echo plugins_url("../../images/empty.gif", __FILE__); ?>" class="subitem_al_imgs_<?php echo $unq; ?>_<?php echo $counting; ?>" alt="" style='width:<?php echo $gritem['imwidth']; ?>px;height:<?php echo $gritem['imheight']; ?>px;'/>
          </div>
          <?php
            }
          }
...
?>
<div class="subitem_al_wrapper"  id="subitem_al_wrapper_<?php echo $unq; ?>" style="display:none;">
...
foreach ($items['containers'] as $ctnkey=>$ctn)
  {
    if ($ctnkey == (int)$container_show_id)
  {
 ...
 <div id="subitem_al_item_<?php echo $ctnkey; ?>" class="subitem_al_item subitem_al_item_<?php echo $unq; ?>_<?php echo $ctnkey; ?>" style="width:<?php if (isset($items['main']['activewidth']))echo $items['main']['activewidth']; ?>px;height:<?php if (isset($items['main']['activeheight']))echo $items['main']['activeheight']; ?>px;">
   <div id="subitem_al_subitem_<?php echo $ctnkey; ?>_01"  class="subitem_al_subitem" style="width:<?php if (isset($items['main']['activewidth']))echo $items['main']['activewidth']; ?>px;height:<?php if (isset($items['main']['activeheight']))echo $items['main']['activeheight']; ?>px;">

          <?php
          if (isset($ctn['bgurl'])&&(!empty($ctn['bgurl'])))
            {
          ?>
          <a href='<?php echo $ctn['bgurl']; ?>'><img class="subitem_al_bgs_<?php echo $unq; ?>_<?php echo $ctnkey; ?>" src="#" style="width:<?php if (isset($items['main']['activewidth']))echo $items['main']['activewidth']; ?>px;height:<?php if (isset($items['main']['activeheight']))echo $items['main']['activeheight']; ?>px;"></a>
          <?php
            }
          else
            {
          ?>
          <img class="subitem_al_bgs_<?php echo $unq; ?>_<?php echo $ctnkey; ?>" src="#" style="width:<?php if (isset($items['main']['activewidth']))echo $items['main']['activewidth']; ?>px;height:<?php if (isset($items['main']['activeheight']))echo $items['main']['activeheight']; ?>px;">
          <?php
            }
            ?>
    
   </div>
      <div id="subitem_al_subitem_<?php echo $ctnkey; ?>_02"  class="subitem_al_subitem"> <!--style="display:none;"-->
       <div class="subitem_al_slider-wrapper">
        <div id="subitem_al_slider<?php echo $ctnkey; ?>">
<?php
if ((isset($ctn['groups'])&&(is_array($ctn['groups'])&&(!empty($ctn['groups'])))))
  foreach ($ctn['groups'] as $gr)
    ...
    ?>
          <div class="subitem_al_slide1" style="width:<?php if (isset($maxwidth))echo $maxwidth; ?>px;height:<?php if (isset($maxheight))echo $maxheight; ?>px;">
<?php
  list($counting, $container_child_script) = out_groups_inside($gr, $container_child_script, $counting, $ctnkey, $unq);
      ?>
      </div>
        ...
        $containers_functions_end = "";
          ...
          if (isset($mv['groups']))
           ...
           if (!empty($mv['mvurl'])) echo "<a href='".$mv['mvurl']."'>";
              echo "<div class='subitem_al_group_elem ".substr($mv['id_selector'],1)."' style='display:none;'>";
            foreach ($mv['groups'] as $grp_by_id)
             {
                  list($counting, $container_child_script) = out_groups_inside($grp_by_id, $container_child_script, $counting, $ctnkey, $unq);
             }
...
<button name="play" id="play_one_slide" style="padding:10px;">Play</button>
...
$('.subitem_al_item').css('display', 'block');

$('#play_one_slide').click(function(){
...
var myElement = document.getElementById("subitem_al_wrapper_<?php echo $unq; ?>");
...
$( window ).resize(function() {
        if($(window).height()!=lastWindowHeight || $(window).width()!=lastWindowWidth){
            ...
            lastWindowHeight = 0;//$(window).height();
            lastWindowWidth = 0;//$(window).width();
